        ...
        try
        {
            ...
            lock (_lockObject)
            {
                ...
                mappingEntries.Add(new MappingEntry
                {
                    ...
                    ApprovedAt = !isAutoGenerated ? DateTime.UtcNow : null,
                    ApprovedBy = !isAutoGenerated ? approvedBy : null
                });
                ...
                _logger.LogInformation("Saved help guide mapping: {WorkflowId}:{StepId} -> {GuideFile} (auto-generated: {IsAutoGenerated})", workflowId, normalizedStepId, guideFile, isAutoGenerated);
            }
        ...
        try
        {
            ...
            foreach (var mapping in mappingsArray.EnumerateArray())
            {
                var entry = new MappingEntry
                {
                    ...
                    ApprovedAt = mapping.TryGetProperty("approvedAt", out var aa) && aa.ValueKind != JsonValueKind.Null ? DateTime.Parse(aa.GetString() ?? "") : null,
                    ApprovedBy = mapping.TryGetProperty("approvedBy", out var ab) && ab.ValueKind != JsonValueKind.Null ? ab.GetString() : null
                };
                entries.Add(entry);
            }
