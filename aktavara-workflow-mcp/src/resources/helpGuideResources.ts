...
const helpGuideCache: Map<string, Resource[]> = new Map();

export async function createHelpGuideResources(): Promise<Resource[]> {
...
export async function getHelpGuideResourceContent(
  uri: string
): Promise<any | null> {
